...
export default class AllnetModule extends Module 
{
    register(app: Application): void
    {
        ...
        app.post("/sys/servlet/PowerOn", function (req, res)
        {
            ...
            let shopNick = Config.getConfig().shopNickname || 'Bayshore';
            let placeId = Config.getConfig().placeId || 'JPN0123';
            let country = Config.getConfig().country || 'JPN';
            ...
            const resParams = {
                ...
                nickname: shopNick,
                region0: regionId,
                region_name0: region[0][110][0],
                region_name1: region[1][45][0],
                region_name2: region[0][110][0],
                region_name3: region[0][110][0],
                country: country,
                allnet_id: regionId,
                timezone: "007:00",
                setting: 1,
